...
# Deploy a single HANA VM to Azure
...
# Deploy a single application server VM to Azure
...
# Deploy multiple HANA VMs to Azure
...
# Deploy multiple application server VMs to Azure
